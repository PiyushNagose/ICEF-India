            ...
            <div>
              ...
              {project.publicSlug && (
                <div className="mt-4 flex w-fit max-w-full flex-wrap items-center gap-2 rounded-2xl border border-orange-100 bg-orange-50/60 px-3 py-2 shadow-[0_8px_24px_rgba(234,88,12,0.06)]">
                  ...
                  <code className="max-w-[360px] truncate whitespace-nowrap rounded-full border border-orange-200 bg-white px-3 py-1.5 font-mono text-xs font-semibold text-orange-700">
                  ...
                  <button
                    ...
                    className="inline-flex h-8 items-center gap-1.5 whitespace-nowrap rounded-full px-2.5 text-xs font-bold text-orange-600 transition-colors hover:bg-white hover:text-orange-700"
                  >
                  ...
                  {isPublished ? (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex h-8 items-center gap-1.5 whitespace-nowrap rounded-full px-2.5 text-xs font-bold text-slate-700 transition-colors hover:bg-white hover:text-orange-700"
                    >
                        ...
                        >
                          ...
                          <div className="min-w-0">
                            ...
                            <div className="mt-2 flex flex-wrap items-center gap-2">
                              <span className="whitespace-nowrap rounded-full bg-gray-100 px-2.5 py-1 text-[11px] font-bold text-gray-600">
