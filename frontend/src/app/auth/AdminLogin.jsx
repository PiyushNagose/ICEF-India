...
import { Eye, EyeOff, CheckCircle, Shield, Landmark, LockKeyhole, ShieldCheck } from "lucide-react";
            ...
            <div className="flex-1 flex flex-col justify-center px-8 py-8">
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                >
                  ...
                  <div className="rounded-lg bg-gray-50 border border-gray-100 px-4 py-2.5 text-xs text-gray-500">
