...
applicationSchema.index({ jobId: 1, status: 1, submittedAt: -1 });
applicationSchema.index({ jobId: 1, paymentStatus: 1, status: 1 });
applicationSchema.index({ status: 1, paymentStatus: 1, submittedAt: -1 });
applicationSchema.index({ "correction.status": 1, updatedAt: -1 });
