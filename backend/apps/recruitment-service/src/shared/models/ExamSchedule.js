...
const examScheduleSchema = new mongoose.Schema(
  {
    ...
    admitCardTemplateConfig: {
      ...
      organizationNameLocal: { type: String, trim: true },
      documentTitle: { type: String, trim: true },
      sealText: { type: String, trim: true },
      provisionalNote: { type: String, trim: true },
      instructionHeading: { type: String, trim: true },
      photoBoxText: { type: String, trim: true },
      controllerTitle: { type: String, trim: true },
    },
    ...
    admitSetupVerifiedAt: Date,
    admitSetupVerifiedBy: { type: mongoose.Schema.Types.ObjectId, ref: "Employee" },
    admitSetupVersion: { type: Number, default: 0 },
    publishedAt: Date,
